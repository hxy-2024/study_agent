...
describe('Chapter mentor state diagnostics', () => {
  beforeEach(() => {
    fetchMock.mockReset()
  ...
  it('does not expose mentor-state diagnostics in the chat learning interface', async () => {
    ...
    expect(wrapper.text()).not.toContain('Mentor assessment')
    expect(wrapper.text()).not.toContain('Update assessment')
  })
})
