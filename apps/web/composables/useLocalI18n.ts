...
const translations: Record<Locale, Record<TranslationKey, string>> = {
  'en-US': {
    ...
    'create.subtitle': 'Set the goal, upload material, build the retrieval index, review the AI route, and enter chapter study.',
    'create.step1': 'Step 1',
    ...
    'create.step2': 'Step 2',
    'create.materialRag': 'Material and retrieval index',
    ...
    'create.embeddingPreset': 'Retrieval vector model',
    'create.localChunkEmbeddings': 'Local retrieval vectors',
    'create.currentDefaultModel': 'Current default model',
    'create.runIngestion': 'Build retrieval index',
    'create.runningIngestion': 'Building index...',
    'create.step3': 'Step 3',
    ...
    'create.fillRag': 'Fill in the space name, learning goal, and material before building the retrieval index.',
  ...
  'zh-CN': {
    ...
    'create.title': '创建学习空间',
    'create.subtitle': '设定目标、上传资料、生成检索索引、检查 AI 路线，然后进入章节学习。',
    'create.step1': '第 1 步',
    ...
    'create.embeddingPreset': '检索向量模型',
    'create.localChunkEmbeddings': '本地检索向量',
    'create.currentDefaultModel': '当前默认模型',
    'create.runIngestion': '生成检索索引',
    'create.runningIngestion': '正在生成索引...',
    'create.step3': '第 3 步',
    ...
    'create.fillRag': '请先填写学习空间名称、学习目标和资料，再生成检索索引。',
